...
// and copies, so it's a #define opt-in.
        ...
        {
            System.Text.Encoding encoding = AsnCharacterStringEncodings.GetEncoding(encodingType);
        ...
        private void WriteCharacterStringCore(Asn1Tag tag, System.Text.Encoding encoding, ReadOnlySpan<char> str)
        {
            int size = -1;
        ...
        private void WriteConstructedCerCharacterString(Asn1Tag tag, System.Text.Encoding encoding, ReadOnlySpan<char> str, int size)
        {
